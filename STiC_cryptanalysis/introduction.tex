...
\begin{frame}
	\frametitle{Unitary Transformation}
		...
		\vspace{-1cm}
	{\normalsize
	\hspace{0.5cm}{Unitary transformation is a bijective function: }
	$$ U:H_1 \to H_2 $$
%where $$H_{1} and H_{2}$$ are Hilbert spaces, such that\\
%$$\langle Ux,Uy\rangle _{H_{2}}=\langle x,y\rangle _{H_{1}} \langle Ux,Uy\rangle _{{H_{2}}}=\langle x,y\rangle _{{H_{1}}}$$
