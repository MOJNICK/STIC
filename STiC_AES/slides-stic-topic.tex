...
\begin{frame}
	...
	\item[4.]{Quantum Fourier Transform}
	\item[5.]{Shore's factorization algorithm}
	\item[6.]{Exponentiation by squaring}
	\end{description}
	}
\end{frame}
...
\begin{frame}
	...
	{\normalsize
	\hspace{0.5cm}{	
Bra–ket notation is a standard notation for describing quantum states. It can also be used to denote abstract vectors, linear functionals and scalar product in mathematics.
	\vspace{0.4cm}
$\braket{x|y}$

The left part, $\bra{x}$ called the bra, is a row vector.

The right part, $\ket{x}$ called the ket, is a column vector.
